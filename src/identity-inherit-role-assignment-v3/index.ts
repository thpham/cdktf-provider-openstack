// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/identity_inherit_role_assignment_v3
...
export class IdentityInheritRoleAssignmentV3 extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/identity_inherit_role_assignment_v3 openstack_identity_inherit_role_assignment_v3} Resource
  *
  * @param scope The scope in which to define this construct
