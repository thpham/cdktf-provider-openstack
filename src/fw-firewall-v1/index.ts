// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/fw_firewall_v1
...
export interface FwFirewallV1Config extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly associatedRouters?: string[];
  /**
  ...
  */
  readonly noRouters?: boolean | cdktf.IResolvable;
  /**
  ...
  */
  readonly timeouts?: FwFirewallV1Timeouts;
}
...
export function fwFirewallV1TimeoutsToTerraform(struct?: FwFirewallV1Timeouts | cdktf.IResolvable): any {
...
export function fwFirewallV1TimeoutsToHclTerraform(struct?: FwFirewallV1Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FwFirewallV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FwFirewallV1Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: FwFirewallV1Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class FwFirewallV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "openstack_fw_firewall_v1";
  ...
  * @param importToId The construct id used in the generated config for the FwFirewallV1 to import
  * @param importFromId The id of the existing FwFirewallV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/fw_firewall_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FwFirewallV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "openstack_fw_firewall_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/fw_firewall_v1 openstack_fw_firewall_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FwFirewallV1Config
  */
  public constructor(scope: Construct, id: string, config: FwFirewallV1Config) {
    super(scope, id, {
      terraformResourceType: 'openstack_fw_firewall_v1',
    ...
    this._associatedRouters = config.associatedRouters;
    this._description = config.description;
    this._id = config.id;
    this._name = config.name;
    this._noRouters = config.noRouters;
  ...
  // associated_routers - computed: true, optional: true, required: false
  private _associatedRouters?: string[]; 
  public get associatedRouters() {
    return cdktf.Fn.tolist(this.getListAttribute('associated_routers'));
  }
  public set associatedRouters(value: string[]) {
    this._associatedRouters = value;
  }
  public resetAssociatedRouters() {
    this._associatedRouters = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get associatedRoutersInput() {
    return this._associatedRouters;
  }
  ...
  // no_routers - computed: false, optional: true, required: false
  private _noRouters?: boolean | cdktf.IResolvable; 
  public get noRouters() {
    return this.getBooleanAttribute('no_routers');
  }
  public set noRouters(value: boolean | cdktf.IResolvable) {
    this._noRouters = value;
  }
  public resetNoRouters() {
    this._noRouters = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get noRoutersInput() {
    return this._noRouters;
  }
  ...
  private _timeouts = new FwFirewallV1TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: FwFirewallV1Timeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      associated_routers: cdktf.listMapper(cdktf.stringToTerraform, false)(this._associatedRouters),
      description: cdktf.stringToTerraform(this._description),
      id: cdktf.stringToTerraform(this._id),
      name: cdktf.stringToTerraform(this._name),
      no_routers: cdktf.booleanToTerraform(this._noRouters),
      policy_id: cdktf.stringToTerraform(this._policyId),
      region: cdktf.stringToTerraform(this._region),
      tenant_id: cdktf.stringToTerraform(this._tenantId),
      value_specs: cdktf.hashMapper(cdktf.stringToTerraform)(this._valueSpecs),
      timeouts: fwFirewallV1TimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      associated_routers: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._associatedRouters),
        isBlock: false,
        type: "set",
      ...
      no_routers: {
        value: cdktf.booleanToHclTerraform(this._noRouters),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      timeouts: {
        value: fwFirewallV1TimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "FwFirewallV1Timeouts",
      },
    };
