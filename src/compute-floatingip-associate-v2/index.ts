// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/compute_floatingip_associate_v2
...
export class ComputeFloatingipAssociateV2 extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "openstack_compute_floatingip_associate_v2";
  ...
  * @param importFromId The id of the existing ComputeFloatingipAssociateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/compute_floatingip_associate_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "openstack_compute_floatingip_associate_v2", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/resources/compute_floatingip_associate_v2 openstack_compute_floatingip_associate_v2} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ComputeFloatingipAssociateV2Config) {
    super(scope, id, {
      terraformResourceType: 'openstack_compute_floatingip_associate_v2',
    ...
    this._waitUntilAssociated = config.waitUntilAssociated;
  ...
  // wait_until_associated - computed: false, optional: true, required: false
  private _waitUntilAssociated?: boolean | cdktf.IResolvable; 
  public get waitUntilAssociated() {
    return this.getBooleanAttribute('wait_until_associated');
  }
  public set waitUntilAssociated(value: boolean | cdktf.IResolvable) {
    this._waitUntilAssociated = value;
  }
  public resetWaitUntilAssociated() {
    this._waitUntilAssociated = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get waitUntilAssociatedInput() {
    return this._waitUntilAssociated;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      wait_until_associated: cdktf.booleanToTerraform(this._waitUntilAssociated),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      wait_until_associated: {
        value: cdktf.booleanToHclTerraform(this._waitUntilAssociated),
        isBlock: false,
        type: "simple",
