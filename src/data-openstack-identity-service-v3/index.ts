// https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/data-sources/identity_service_v3
...
export class DataOpenstackIdentityServiceV3 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpenstackIdentityServiceV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/data-sources/identity_service_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-provider-openstack/openstack/1.54.1/docs/data-sources/identity_service_v3 openstack_identity_service_v3} Data Source
  *
  * @param scope The scope in which to define this construct
